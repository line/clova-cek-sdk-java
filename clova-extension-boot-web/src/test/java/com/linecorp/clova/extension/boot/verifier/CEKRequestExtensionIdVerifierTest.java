...
@TestPropertySource(properties = "cek.verifier.extension-id.enabled=true")
public class CEKRequestExtensionIdVerifierTest {
    ...
    static class TestConfig {
        ...
        static class TestHandler {
            ...
            @IntentMapping("CEKRequestExtensionIdVerifierTest")
    ...
    public void test_noApplicationId() throws Throwable {
        ...
        verify(handler, never()).handleExtensionIdVerifierTest();

        assertThat(captor.getValue()).isExactlyInstanceOf(SecurityException.class)
                                     .hasMessage("applicationId is missing.");
    }

    @Test
    public void test_hasApplicationId_wrongApplicationId() throws Throwable {
        doCallRealMethod().when(advice).handle(captor.capture());
        ...
        assertThat(captor.getValue()).isExactlyInstanceOf(SecurityException.class)
                                     .hasMessage(String.format("[%s] is not expected applicationId.",
                                                               applicationId));
    }

    @Test
    public void test_hasApplicationId_correctApplicationId() throws Throwable {
