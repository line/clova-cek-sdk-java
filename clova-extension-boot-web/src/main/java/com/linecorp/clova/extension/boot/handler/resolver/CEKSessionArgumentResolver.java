...
/**
 * {@link CEKRequestHandlerArgumentResolver} for {@link CEKRequestMessage.Session}.
 */
public class CEKSessionArgumentResolver implements CEKRequestHandlerArgumentResolver {

    @Override
    public boolean supports(MethodParameter methodParam) {
        return methodParam.getParameterType() == CEKRequestMessage.Session.class;
    }
