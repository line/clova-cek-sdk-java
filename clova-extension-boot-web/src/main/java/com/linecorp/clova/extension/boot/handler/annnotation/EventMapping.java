...
/**
 * An annotation for performing EventRequest mapping.
 * <p>
 * When defining the following Handler method to process the EventRequest:
 * <pre><code>
 * "request": {
 *   "type": "EventRequest",
 *   "event": {
...
@Documented
@CEKRequestMapping(type = RequestType.EVENT)
