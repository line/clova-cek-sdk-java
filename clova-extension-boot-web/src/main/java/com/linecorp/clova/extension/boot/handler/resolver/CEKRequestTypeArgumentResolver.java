...
/**
 * {@link CEKRequestHandlerArgumentResolver} for {@link RequestType}.
 */
public class CEKRequestTypeArgumentResolver implements CEKRequestHandlerArgumentResolver {

    @Override
    public boolean supports(MethodParameter methodParam) {
        return methodParam.getParameterType() == RequestType.class;
    }

    @Override
    public Object resolve(MethodParameter methodParam, CEKRequestMessage requestMessage) {
        return requestMessage.getRequest().getType();
    }
