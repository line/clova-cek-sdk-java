...
/**
 * An annotation for performing SessionEndedRequest mapping.
 * <p>
 * Handler example:
 * <pre><code>
 * &#64;SessionEndedMapping
...
@Documented
@CEKRequestMapping(type = RequestType.SESSION_ENDED, nameRequired = false)
public @interface SessionEndedMapping {
}
